...
export function GetAQuoteButton({
  ...
  return (
    <Link
      ...
      className={
        isGold
          ? `flex h-11 min-w-[176px] items-center justify-center rounded-[22px] px-6 py-2.5 text-sm font-medium leading-5 text-white transition-opacity hover:opacity-95 focus-visible:outline focus-visible:ring-2 focus-visible:ring-white/50 nav-cta-gradient ${className ?? ""}`
