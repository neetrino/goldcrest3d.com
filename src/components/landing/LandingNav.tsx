...
export function LandingNav() {
  ...
  return (
    <nav
      className="fixed inset-x-0 top-0 z-50 h-[length:var(--landing-nav-height)] w-full bg-white/97 backdrop-blur-sm"
    ...
    >
      <div className="mx-auto grid h-full w-full max-w-[1612px] min-w-0 grid-cols-[1fr_auto_1fr] items-center gap-x-2 px-[length:var(--landing-nav-padding-x)] sm:gap-x-3 lg:gap-x-6">
        ...
        <ul
          className="col-start-2 row-start-1 hidden w-max min-w-0 list-none items-center justify-self-center gap-[clamp(0.75rem,2.4vw,4rem)] lg:flex"
