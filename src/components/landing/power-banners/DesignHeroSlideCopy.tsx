    ...
    >
      <div className="power-banners-section3-text-cluster flex w-full flex-col items-end gap-7 text-right text-[#121212] max-md:-translate-y-[7.5rem] md:translate-y-0 md:items-start md:gap-8 md:text-left">
        ...
        <div className="flex w-full flex-col items-end gap-0.5 md:items-start md:gap-1">
          {useRichBody ? (
            <div className="hero-primary-subtitle-typography-design w-full min-w-0 max-w-full self-end text-right whitespace-normal max-md:-translate-y-5 md:-translate-y-4 md:self-start md:text-left [&_.hero-banner-rich-body]:whitespace-normal">
            ...
            <p className="hero-primary-subtitle-typography-design w-full min-w-0 max-w-full self-end text-right max-md:-translate-y-5 md:-translate-y-4 md:self-start md:text-left">
              {lines.map((line, i) => (
                <span
                  key={i}
                  className={
