...
function ModelingSlotCopyEditorContent({
  ...
  const triggerSubtitle = tabletOnly
    ? "Tablet viewport (768px–1023px). Click to open editor."
          ...
          >
            ...
            <div className="p-4 sm:p-6">
              <p className="mb-4 text-sm text-slate-600">
                {tabletOnly
                  ? "Tablet tier only (768px–1023px). Each line break is a new line. Empty fields hide text on tablet. Desktop and mobile copy are unchanged."
