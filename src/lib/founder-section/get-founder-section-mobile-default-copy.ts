...
export function getFounderSectionMobileDefaultCopyMap(): Map<string, string> {
  return new Map<string, string>([
    [FOUNDER_SECTION_MOBILE_COPY_KEYS.HEADING, "Founder & Lead CAD Engineer"],
    [FOUNDER_SECTION_MOBILE_COPY_KEYS.NAME, "Davit Sargsyan"],
    [
    ...
    [FOUNDER_SECTION_MOBILE_COPY_KEYS.STAT_YEARS_VALUE, "16+"],
    [FOUNDER_SECTION_MOBILE_COPY_KEYS.STAT_YEARS_CAPTION, "Years Experience"],
    [FOUNDER_SECTION_MOBILE_COPY_KEYS.STAT_PROJECTS_VALUE, "2.5k+"],
    [FOUNDER_SECTION_MOBILE_COPY_KEYS.STAT_PROJECTS_CAPTION, "Projects Delivered"],
    [FOUNDER_SECTION_MOBILE_COPY_KEYS.IMAGE_ALT, "Davit Sargsyan"],
  ]);
}
