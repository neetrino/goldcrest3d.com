/** Stored DB values and admin: desktop/mobile vertical copy offset as CSS translateY % (-100…100). */
export const MODELING_COPY_OFFSET_Y_MIN_PCT = -100;
export const MODELING_COPY_OFFSET_Y_MAX_PCT = 100;
